...
export const products = [
  {
    ...
    images: [productImg("headphones", 1), productImg("headphones", 13)],
  ...
  },
  {
    ...
    images: [productImg("smartwatch", 3)],
    category: "Electronics",
  ...
  },
  {
    ...
    rating: 4.6, sold: "500",
    images: [productImg("headphones", 4)],
    category: "Electronics",
  ...
  },
  {
    ...
    images: [productImg("camera", 10, 600, 600)],
    category: "Electronics",
  ...
  },
  {
    ...
    rating: 4.8, sold: "850",
    images: [productImg("camera", 11, 600, 600)],
    category: "Electronics",
    verified: true, isMall: true,
  ...
  },
  {
    ...
    rating: 4.7, sold: "2k",
    images: [productImg("headphones", 12)],
    category: "Electronics",
    verified: true, isMall: false,
    shopName: "AudioDeals",
    discountPct: 40,
...
export const deals = [
  { id: "d01", productId: "p12", title: "Noise-Cancelling Headphones Pro", price: 59.90, discountLabel: "-40%", image: productImg("headphones", 12) },
  { id: "d02", productId: "p03", title: "Smart Watch Series 7",             price: 129.00, discountLabel: "-32%", image: productImg("smartwatch", 3) },
  { id: "d03", productId: "p05", title: "Vitamin C Face Serum 30ml",        price: 24.90, discountLabel: "BOGO", image: productImg("skincare", 5) },
];

export const recentOrders = [
  { id: "r01", title: "Mixed Nuts 500g",    image: productImg("snacks", 20, 96, 96) },
  { id: "r02", title: "Energy Drink Case",  image: productImg("drink", 21, 96, 96) },
  { id: "r03", title: "Ruled Notebooks x3", image: productImg("notebook", 22, 96, 96) },
];
